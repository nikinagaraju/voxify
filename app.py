...
@st.cache_resource
def load_embedder():
    return SentenceTransformer("paraphrase-albert-small-v2", device=device_embed)
embedder = load_embedder()
@st.cache_resource
def load_whisper():
    return WhisperModel("tiny", device=device_whisper, compute_type="int8")
...
def download_audio(youtube_url):
    ...
    ydl_opts = {
        ...
        "ffmpeg_location": "C:/ffmpeg/ffmpeg-8.1.1-essentials_build/bin"  # change if different
    }
